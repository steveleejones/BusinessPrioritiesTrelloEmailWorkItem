    ...
    public class Emailer
    {
        ...
        public static string EmailContent(List<TrelloList> Lists, string name)
        {
            ...
            foreach (TrelloList list in Lists)
            {
                ...
                sb.Append("<tr style='color:red;'><td colspan='5'>" + list.Name + " (" + list.Cards.Count.ToString() + " items)</td></tr>");
                sb.Append("<tr style='font-weight:bold;'><td style='background-color:red;text-align:center;width:5%;'>LCTG ID</td><td style='background-color:yellow;text-align:center;width:5%;'>Zendesk ID</td><td colspan='2'>Summary</td><td>Item Added</td></tr>");
                ...
                foreach (TrelloCard cardItem in list.Cards)
                {
                    ...
                    sb.Append("<tr style='background-color:#46adad;border:none;'><td style='text-align:center;'>");
                    sb.Append(items[0]);
                    sb.Append("</td><td style='text-align:center;'>");
                    if (items.Count > 1)
                        sb.Append(items[1]);
                    sb.Append("</td><td colspan='2'>" + nameWithNoIds + "</td><td>" + cardItem.DateCreated + "</td></tr>");
            ...
            sb.Append(Environment.NewLine);
            sb.Append("<p>The aim of this report is to highlight issues managed by the Application (iVector) Support team which have a high level of urgency due to financial or commercial impact.</p>");
            sb.Append(Environment.NewLine);
            sb.Append("<p>Please feel free to raise any queries to me directly regarding the content or quality of this report. If advising of urgent items that are not considered in this report, please note LCTG ticket ID(s) where possible and detail the impact to the business.</p>");
            sb.Append("<p><h3>Dave Evans<h3></p>");
